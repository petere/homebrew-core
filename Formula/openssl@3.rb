class OpensslAT3 < Formula
  ...
  url "https://www.openssl.org/source/openssl-3.0.0-alpha9.tar.gz"
  mirror "https://www.mirrorservice.org/sites/ftp.openssl.org/source/openssl-3.0.0-alpha9.tar.gz"
  sha256 "5762545c972d5e48783c751d3188ac19f6f9154ee4899433ba15f01c56b3eee6"
  license "Apache-2.0"
  version_scheme 1

  livecheck do
    url "https://www.openssl.org/source/"
    regex(/href=.*?openssl-(3\.[-0-9a-z.]+)\.t/i)
  end

  head do
    url "https://github.com/openssl/openssl.git", branch: "master"
  end
